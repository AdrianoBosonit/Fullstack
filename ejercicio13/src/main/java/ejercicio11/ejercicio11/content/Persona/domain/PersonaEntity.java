...
/*
    boolean asignadoEstudiante(EstudianteEntity estudiante) throws Exception {
        if (Optional.ofNullable(this.getEstudiante()).isEmpty()) {
            if (Optional.ofNullable(estudiante.getPersona()).isEmpty()) {
                if (Optional.ofNullable(this.getProfesor()).isEmpty()) {
                    return true;
                } else {
                    throw new Exception("Esta persona tiene asignado ya un profesor y no se le puede asignar un estudiante");
                }
            } else {
                throw new Exception("Este estudiante tiene asignado ya una persona");
            }
        } else {
            throw new Exception("Esta persona tiene asignado ya un estudiante");
        }
    }*/
}
