...
public class PersonaEntity {
    ...
    public void modificar(PersonaInputDTO personaDTO) throws Exception {
        if (personaDTO.getUsuario().length() < 6) {
            throw new Exception("longitud de usuario no puede ser menor que 6. No se ha modificado nada");
        }
        if (personaDTO.getUsuario().length() > 10) {
            throw new Exception("longitud de usuario no puede ser mayor que 10. No se ha modificado nada");
        }
